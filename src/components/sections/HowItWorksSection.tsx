      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-[#333333] mb-6">
            From Site Data to Secure Financing in <span className="text-[#6ACF30]">3 Simple Steps</span>
          </h2>
        </div>
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <h3 className="text-2xl font-bold text-[#333333] mb-4">1. Install & Collect</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-2xl font-bold text-[#333333] mb-4">2. Track & Improve</h3>
            <p className="text-gray-600 leading-relaxed">
          ...
          <div className="text-center">
            ...
            <h3 className="text-2xl font-bold text-[#333333] mb-4">3. Unlock & Grow</h3>
            <p className="text-gray-600 leading-relaxed">
